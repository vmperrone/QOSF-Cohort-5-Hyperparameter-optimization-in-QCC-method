...
def get_molGeometry(name, BL):
    geometries = {
        ...
        'O2':[['O',(0,0,0)], ['O',(BL,0,0)]],
        'HCONH2':[['O',(1.1280,0.2091,0.0000)], ['N',(-1.1878,0.1791,0.0000)], ['C',(0.0598,-0.3882,0.0000)], ['H',(-1.3085,1.1864,0.0001)], ['H',(-2.0305,-0.3861,-0.0001)], ['H',(-0.0014,-1.4883,-0.0001)], ['C',(-0.1805,1.3955,0.000)]]
    }
